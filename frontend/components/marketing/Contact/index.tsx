    ...
    <>
      ...
      <section id="support" className="px-4 md:px-8 2xl:px-0">
        <div className="relative mx-auto max-w-c-1390 px-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          {/* Dotted background container removed here */}
            ...
            >
              ...
              <div className="mb-7">
                ...
                <div className="space-y-2">
                  <p>
                    <a href="ryanlokng@gmail.com" className="hover:text-primary">
                      ryanlokng@gmail.com
                    </a>
                  </p>
                  <p>
                    <a href="mailto:partners@company.com" className="hover:text-primary">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <p>
                    <a href="tel:+852 9546 7543" className="hover:text-primary transition-colors">
                      +852 9546 7543
                    </a>
                  </p>
                  <p>
                    <a href="tel:+1(437) 818-9995" className="hover:text-primary transition-colors">
                      +1(437) 818-9995
                    </a>
                  </p>
                </div>
