...
const StudentInfoForm: React.FC = () => {
  ...
  const nextStep = useCallback(() => {
    ...
    if (currentStep === 1) {
      gainXP(10); // Basic info completion
      ...
      gainXP(15); // Education completion
    } else if (currentStep === 3) {
      gainXP(15); // Career completion
    } else if (currentStep === 4) {
      gainXP(20); // Skills completion
      // Award extra XP for multiple skills
      ...
      gainXP(15); // Availability completion
    } else if (currentStep === 6) {
      gainXP(15); // Compensation completion
    }

    setCurrentStep((prev) => Math.min(prev + 1, 7));
    setErrors({});
  }, [currentStep, formData, validateStep, gainXP, unlockAchievement]);
  ...
  const handleSubmit = useCallback(
    (e: React.FormEvent) => {
      ...
      // Award XP for completing the entire profile
      gainXP(50);
    ...
    [formData, currentStep, validateStep, router, gainXP, unlockAchievement]
  );
