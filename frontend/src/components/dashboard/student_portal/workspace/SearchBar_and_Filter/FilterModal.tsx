    ...
    <>
      {isOpen && (
        <div className="absolute top-0 left-0 right-0 z-50">
          {/* Dropdown modal */}
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 max-h-[80vh] overflow-y-auto">
            <div className="p-6">
              ...
              {occupations.map((occ) => (
                <motion.button
                  ...
                  className={`px-4 py-2 rounded-full border text-sm transition-all ${filters.occupation === occ
                    ...
                    : "border-gray-300 dark:border-gray-700 text-gray-700 dark:text-white hover:border-primary/50"
                    }`}
