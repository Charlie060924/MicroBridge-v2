          ...
          {jobs.map((job, index) => {
            ...
            return (
              <motion.div
                ...
                className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-150 cursor-pointer group relative overflow-hidden"
              >
                {skillMatch > 70 && (
