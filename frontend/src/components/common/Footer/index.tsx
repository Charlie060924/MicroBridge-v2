            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              <div className="w-1/2 lg:w-1/4">
                ...
                <p className="mb-10 mt-5">
                  Connecting Hong Kong's future talent with innovative startups through micro-internships.
                </p>

                <p className="mb-1.5 text-sectiontitle uppercase">
                  contact
                </p>
                <a
                  href="#"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            <div className="animate_top">
              <ul className="flex items-center gap-8">
                ...
                <li>
                  <a href="/terms_of_services" className="hover:text-primary">
                    Terms of Service
                  </a>
                </li>
              </ul>
            ...
            <div className="animate_top">
              <p>
                &copy; {new Date().getFullYear()} MicroBridge. All rights reserved
              </p>
            </div>
