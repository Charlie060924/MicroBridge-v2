...
import { Globe, Edit2, ExternalLink, X, Check, FolderPlus } from 'lucide-react';
import { isValidUrl } from './types';

interface TraditionalPortfolioSectionProps {
  portfolioUrl: string;
  onUpdate: (url: string) => void;
  onSwitchToAdvanced: () => void;
}

const TraditionalPortfolioSection: React.FC<TraditionalPortfolioSectionProps> = ({
  portfolioUrl,
  onUpdate,
  onSwitchToAdvanced
}) => {
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-colors duration-200"
          >
...
export default TraditionalPortfolioSection;