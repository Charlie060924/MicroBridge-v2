...
import { Shield, Eye, Smartphone, Activity, LogOut, AlertTriangle, Building2 } from 'lucide-react';
...
const PrivacySecuritySection: React.FC = () => {
  ...
  return (
    <SettingCard
      ...
      description="Manage your company privacy settings and account security"
    >
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            <ToggleSwitch
              checked={settings.privacy.publicCompanyProfile}
              onChange={(checked) => handlePrivacyChange('publicCompanyProfile', checked)}
              label="Public Company Profile"
              description="Allow candidates to view your company profile information"
            />
            
            <ToggleSwitch
              checked={settings.privacy.showContactInfo}
              onChange={(checked) => handlePrivacyChange('showContactInfo', checked)}
              label="Show Contact Information"
              description="Display contact details to job applicants"
            />
        ...
        <div>
          ...
          <div className="space-y-4">
            <ToggleSwitch
              ...
              description="Add an extra layer of security to your company account"
            />
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                      Protect your company account with an additional security layer. 
                      We strongly recommend enabling this feature for enhanced security.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  ...
                  This will immediately log out that device from your company account.
                </p>
              </div>
            </div>
          </div>
            ...
            <button className="w-full flex items-center justify-between p-4 text-left bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Get a copy of all your company data and job postings
                  </p>
                </div>
              </div>
            </button>

            <button className="w-full flex items-center justify-between p-4 text-left bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700 dark:text-orange-300">
                    Add or remove team members from your company account
                  </p>
                </div>
              </div>
            </button>
