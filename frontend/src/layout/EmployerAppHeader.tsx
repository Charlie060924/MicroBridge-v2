...
const EmployerAppHeader: React.FC = () => {
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <Link
              ...
              className="flex items-center justify-center w-11 h-11 text-white transition-colors bg-green-600 rounded-full hover:bg-green-700"
            >
            ...
            <Link
              ...
              className="flex items-center justify-center w-11 h-11 text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-gray-700 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
            >
...
export default EmployerAppHeader;
