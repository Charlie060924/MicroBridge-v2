...
const JobCategoryCard = dynamic(() => import("./JobCategoryCard"), {
  loading: () => <div className="h-full bg-gray-100 rounded-xl animate-pulse" />,
  ssr: false
});
              ...
              <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          {featuredJobs.slice(0, 3).map((job) => (
                            <div
                              ...
                              className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50  transition-all duration-150 cursor-pointer group"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  {statsCards.map((stat, index) => (
                    <div key={`stat-${stat.label}-${index}`} className="bg-white rounded-xl p-6 border border-gray-200 ">
