    ...
    <div className="bg-white rounded-xl border border-gray-200  relative">
      <div className="p-6 border-b border-gray-200
        <div className="flex items-center justify-between">
          ...
          <Link href="/employer_portal/workspace/candidates" className="text-sm text-blue-600 hover:text-blue-700  font-medium">
            View All
          </Link>
        </div>
      </div>
          ...
          <div className="p-6 pb-24"> {/* Added bottom padding for sticky button */}
            <div className="space-y-4">
              {candidates.map((candidate) => (
                <div
                  key={candidate.id}
                  className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all duration-200 group min-h-[140px] flex flex-col"
                >
                  ...
                  <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100
                    <Link
                      ...
                      className="flex items-center px-3 py-1.5 text-sm text-blue-600 hover:text-blue-700  font-medium hover:bg-blue-50  rounded-md transition-colors"
                    >
