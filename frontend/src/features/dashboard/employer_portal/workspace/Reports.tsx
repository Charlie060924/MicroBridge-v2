            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <select 
                  ...
                  className="text-sm border border-gray-300 rounded-lg px-3 py-1 bg-white  text-gray-900 
                >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <button 
                      ...
                      className="inline-flex items-center px-3 py-1 text-sm text-gray-600 bg-gray-100  rounded-lg hover:bg-gray-200  transition-colors"
                    >
